...
class TestNPDA(unittest.TestCase):
    ...
    def test_accepts_input(self):
        ...
        self.assertEqual(npda.accepts_input("00111010110011100101"),
                         True)  # BUG:
        self.assertEqual(npda.accepts_input("11010001101011001100"),
                         True)  # BUG:
        ...
        self.assertEqual(npda.accepts_input("00110101010011011011"),
                         True)  # BUG:
        ...
        self.assertEqual(npda.accepts_input("10100110110011010100"),
                         True)  # BUG:
        ...
        # self.assertEqual(npda.accepts_input("00101110111011001001"), False) $ Check this one out
        self.assertEqual(npda.accepts_input("11010010001001011101"),
                         False)  # BUG:
        self.assertEqual(npda.accepts_input("01010100110100110101"),
                         False)  # BUG:
        self.assertEqual(npda.accepts_input("10001101010110001110"),
                         True)  # BUG:
        self.assertEqual(npda.accepts_input("01100110011001000101"), False)
        self.assertEqual(npda.accepts_input("10101101101010110100"),
                         True)  # BUG:

    def check_str1_less_than_str2_in_str(
        str_: str,
        str1: str = "110",
        str2: str = "001",
        ...
        counts = [0, 0]
        str_buf = ""
        for i, sym in enumerate(str_):
            if len(str_buf) < len(str1):
                str_buf += sym
            else:
                if str_buf == str1:
                    counts[0] += 1
